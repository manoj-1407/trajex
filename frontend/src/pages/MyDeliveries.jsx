...
import { Truck, CheckCircle, Package, MapPin, Phone, Clock } from 'lucide-react';
...
export default function MyDeliveries() {
  ...
  const pendingOrders = orders.filter(o => o.status === 'assigned').slice(1); // skip the first one shown as current
  ...
  return (
    <div className="fade-in-up" style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
      <h1 style={{ fontSize: '24px', fontWeight: 600, margin: 0 }}>My Deliveries</h1>

      {currentOrder ? (
        <div className="glass-card" style={{ overflow: 'hidden', border: '1px solid var(--border)' }}>
