          ...
          {activeTab === 'business' && (
            <div className="fade-in-up">
               ...
               <div style={{ display: 'flex', flexDirection: 'column', gap: '16px', maxWidth: '400px' }}>
                 ...
                 <Select label="Timezone" options={[{value: 'UTC', label: 'UTC'}]} value={businessForm.timezone} onChange={v => setBusinessForm({...businessForm, timezone: v})} disabled={loading} />
               ...
               <div className="glass-card" style={{ border: '1px solid var(--danger)', padding: '24px' }}>
                  ...
                  <div style={{ maxWidth: '400px' }}>
                    ...
                    <div style={{ display: 'flex', justifyContent: 'flex-start', marginTop: '16px' }}>
                       <Button variant="danger" disabled={deleteConfirm !== 'TRAJEX-DELETE'} onClick={() => window.confirm('Are you absolutely sure?')}>
                         Delete Workspace
                       </Button>
                    </div>
                  </div>
